...
echo '<script>alert("Change Permission Denied !!")</script>';
}
}
...
echo '<script>alert("Change Name Permission Denied !!")</script>';
}
...
echo '<script>alert("Edit File Denied !!")</script>';
}
fclose($fp);
}
echo '<form method="POST">
...
echo '<script>alert("Delete Dir Denied !!")</script>>';
}
}
...
echo '<script>alert("Delete File Denied !!")</script>';
}
}
}
